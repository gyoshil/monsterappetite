...
\def\plaintitle{Observing gameful learning through purchasing decisions}
\def\plainauthor{Maria Hwang, Mark Santolucito}
\def\emptyauthor{}
...
\numberofauthors{2}
\author{%
  \alignauthor{Maria Hwang\\
    \affaddr{Columbia}\\
    \affaddr{NYC, USA}\\
    \email{e-mail address}}\\
  \alignauthor{Mark Santolucito\\
    \affaddr{Yale}\\
    \affaddr{New Haven, USA}\\
    \email{e-mail address}}\\
}
